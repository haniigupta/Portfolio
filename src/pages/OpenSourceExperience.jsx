      ...
      {[
        {
          no:"01",
          repo:"WalletWise",
          title:"Loading Feedback & Refresh Handling",
          problem:"Dashboard actions felt frozen during API requests because there was no visual loading feedback.",
          impact:[
            "Implemented loading indicators across dashboard actions.",
            "Prevented repeated refresh requests and improved user interaction."
          ],
          tech:["React","Frontend","Accessibility"]
        },
        {
          no:"02",
          repo:"File Sharing System",
          title:"Replace Browser Alerts with Toast Notifications",
          problem:"Native browser alerts created an inconsistent and outdated user experience.",
          impact:[
            "Replaced alerts with modern toast notifications.",
            "Improved overall feedback consistency across the application."
          ],
        ...
        },
        {
          no:"03",
          repo:"File Sharing System",
          title:"Authentication Loading Fix",
          problem:"Users remained stuck on the loading screen after successful login.",
          impact:[
            "Resolved authentication loading state.",
            "Restored reliable navigation after login."
          ],
          tech:["React","Authentication","Frontend"]
        },
        {
          no:"04",
          repo:"DevEvent Tracker",
          title:"Homepage Cache Fix",
          problem:"Invalid cache usage caused the homepage to fail while rendering.",
          impact:[
            "Fixed cache implementation.",
            "Improved authentication loading reliability."
          ],
          tech:["Next.js","Backend","Redis"]
        },
        {
          no:"05",
          repo:"Innovision",
          title:"Skeleton Loader & Empty State",
          problem:"Users had no proper empty or error state after loading completed.",
          impact:[
            "Added meaningful empty states.",
            "Improved UX during loading failures."
          ],
          tech:["React","UX","Frontend"]
        },
        {
          no:"06",
          repo:"Fleetiva Roadlines",
          title:"Login UI Design Alignment",
          problem:"Login page was inconsistent with the landing page design system.",
          impact:[
            "Aligned layouts and spacing.",
            "Created a consistent visual experience."
          ],
